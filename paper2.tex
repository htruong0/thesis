...
finite part\footnote{See Section 3.2 and Appendix A.1 in Ref.~\cite{Hirschi:2011pa} for explicit definitions.}
of the interference between the tree-level and 
...
\begin{figure}
    ...
    $[\sqrt{s_{\mathrm{com}}}/8, 8 \sqrt{s_{\mathrm{com}}}]$. Each trajectory
...
varying from $\sqrt{s_{\mathrm{com}}}/8$ to $8\sqrt{s_{\mathrm{com}}}$.
