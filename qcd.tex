...
\subsection{Collinear limits}\label{sec:me_collinear}
    ...
    only true in the strict soft limit, Eqns. (\ref{eqn:F_collinear_factorisation})
...
\subsection{Factorisation of colour-ordered amplitudes}\label{sec:CO_factorisation}
    The factorisation formulae expressed in Eqns. (\ref{eqn:soft_factorisation}),
    ...
    In Eqns. (\ref{eqn:CO_soft_factorisation}) and (\ref{eqn:CO_collinear_factorisation}),
...
\section{Catani-Seymour dipoles}\label{sec:CS_dipoles}
    ...
    \subsection{Final-final dipoles}
        ...
        \end{equation}
        Eqns. (\ref{eqn:FF_mapping}) and (\ref{eqn:y_ijk})
        ...
        behaviour seen in Eqns. (\ref{eqn:soft_factorisation}) and (\ref{eqn:F_collinear_factorisation}),
...
\section{Antenna functions}\label{sec:antenna_functions}
    ...
    Since the one-loop factorisation formulae, Eqns. (\ref{eqn:1L_soft_factorisation})
    ...
    sub-leading colour, and closed quark look contributions.
