...
\subsection{Infrared divergences}
    ...
    modes. Since they are related to low energy
    behaviours they are called IR divergences. There
    are two cases in which these divergences arise:
    in loop integrals (virtual) and when an emission
    of an extra particle becomes soft or collinear
    (real).

    Virtual divergences can be understood by looking
    at the integral (\ref{eqn:loop_integral})
