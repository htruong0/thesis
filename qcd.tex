...
\subsection{Renormalisation}\label{sec:renormalisation}
    ...
    a scale variation (see Section~\ref{sec:sec:scale_variations}). 
...
\subsection{Factorisation of colour-ordered amplitudes}\label{sec:CO_factorisation}
    ...
    The term proportional to $1/N_{c}$ is the leading colour term
...
\section{Catani-Seymour dipoles}\label{sec:CS_dipoles}
    ...
    all the singular limits in a process, it is necessary to construct all
    the permutations of dipole functions.
    ...
    \subsection{Final-initial dipoles}
        ...
        The initial-state parton is represented as $a$.
    ...
    \subsection{Master factorisation formula}
        ...
        relevant and hence will form the set of basis functions for
...
\section{Antenna functions}\label{sec:antenna_functions}
    ...
    of this partonic process is examined in Chapter~\ref{chap:fame2}.
