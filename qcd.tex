...
\subsection{Ultraviolet divergences}\label{sec:UV}
    ...
    if we move away from $d=4$ dimensions
    \footnote{In dimensional regularisation it is possible to regulate
...
\section{Subtraction}\label{sec:subtraction}
    ...
    but specific examples of automated subtractions schemes include
