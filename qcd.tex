...
\section{Catani-Seymour dipoles}\label{sec:CS_dipoles}
    ...
    \begin{figure}
        ...
        \caption{Schematic diagrams of the four classes of Catani-Seymour
            ...
            whether the emitter and spectator are in the initial or final-state.
            lEach dipole consists of a composite particle (denoted by tilde)
            ...
            partons, respectively. represents the splitting
...
\section{Antenna functions}\label{sec:antenna_functions}
    ...
    \begin{figure}
        ...
        \caption{Three-parton antenna functions where the loop order
            is implicitly illustrated in the grey circle,
