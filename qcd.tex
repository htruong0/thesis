...
\section{Subtraction}\label{sec:subtraction}
    ...
    main mathods have been proposed: phase-space slicing (cite here),
    sector decomposition (cite here), and subtraction (cite here).
    ...
    but specific exmples of subtractions schemes include
    Catani-Seymour (CS) (cite here), Frixione-Kunszt-Signer (FKS) (cite here),
    and antenna subtraction (cite here).
