...
This factorisation was used by Catani and Seymour \cite{Catani:1996vz} to construct subtraction terms for the real radiation part of a NLO calculation (Section~\ref{sec:CS_dipoles}).
